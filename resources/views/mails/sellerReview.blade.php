...
<body class="font-poppins text-darkgray flex flex-col items-center justify-center w-screen mt-2">
    ...
    <div class="w-1/3 flex flex-col text-left">
        <p>We hopen dat je tevreden bent met je aankoop van <span class="text-blue font-medium">
                {{$data['product_name']}}</span>.</p>
        <p class="w-max">We zouden het zeer op prijs stellen als je een review zou willen achterlaten over je ervaring met<span
